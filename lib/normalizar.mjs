...
const DESTINO = {
  ...
  ferro: ['ferroMgDm3', 'mg'],
  enxofre: ['enxofreMgDm3', 'mg'],
  zinco: ['zincoMgDm3', 'mg'],
  cobre: ['cobreMgDm3', 'mg'],
  boro: ['boroMgDm3', 'mg'],
  manganes: ['manganesMgDm3', 'mg'],
  sodio: ['sodioMgDm3', 'na'],
};

const ROTULO_UNIDADE = { percentual: '%', ph: 'pH', indice: 'indice', mg: 'mg/dm3', cmolc: 'cmolc/dm3', g_dm3: 'g/dm3', na: 'mg/dm3' };
...
export const FAIXAS = {
  ...
  ferroMgDm3: [0, 1500], enxofreMgDm3: [0, 300], zincoMgDm3: [0, 150], cobreMgDm3: [0, 150], boroMgDm3: [0, 20],
  manganesMgDm3: [0, 800], sodioMgDm3: [0, 3000],
};
...
function fatorUnidade(tipo, unidade) {
  ...
  const tabela = {
    ...
    // Na: 1 cmolc = 23 mg (x 10 do dm3): mg/dm3 = cmolc/dm3 x 230
    na: { 'mg/dm3': 1, 'mgdm3': 1, 'mg/l': 1, 'ppm': 1, 'cmolc/dm3': 230, 'cmolcdm3': 230, 'cmolc/l': 230, 'mmolc/dm3': 23 },
    ph: {}, indice: {},
  }[tipo];
  return tabela[u];
}
...
export function amostraParaLaudo(extraido, amostra) {
  ...
  for (const v of amostra.valores) {
    ...
    campos[nome] = { ...base, valor, ...(fator !== 1 ? { origem: 'convertido', fator } : {}), ...(v.extrator ? { metodoTexto: v.extrator } : {}) };
  }
